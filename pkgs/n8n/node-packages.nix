...
let
  sources = {
    ...
    "aws-sdk-2.1380.0" = {
      ...
      version = "2.1380.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/aws-sdk/-/aws-sdk-2.1380.0.tgz";
        sha512 = "R7vhM3iqINbQVhkIBKB5UbRRKuMD1rwZWuImtDYM1WGpuwmacDhbqtefdwf9fng2n0LHgC81509TYT1xxgQoIQ==";
      };
    };
    "aws-sign2-0.7.0" = {
      name = "aws-sign2";
    ...
    "glob-10.2.5" = {
      ...
      version = "10.2.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/glob/-/glob-10.2.5.tgz";
